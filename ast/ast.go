...
// ArrayLiteral is an expression representing an array in monkey language
...
// IndexExpression is an expression for indexing arrays
type IndexExpression struct {
	Token token.Token // The [ token Left Expression
	Left  Expression
	Index Expression
}
